...
const program2025: Program = {
  ...
  schedule: [
    ...
    },
    {
      ...
      description: "En kort introduksjon til Bergen Open Source-konferansen, med litt praktisk informasjon om kvelden.",
      description_en: "A brief introduction to the Bergen Open Source Conference, including some practical information about the evening.",
      image: "TODO: path to some image in static dir",
    ...
    },
    {
      ...
      title_en: "The General Data Protection Regulation in Practice for Open Source",
      description: "Virksomheter som tar i bruk åpen kildekode i produksjon møter de samme kravene til personopplysningssikkerhet som alle andre. Foredraget viser hva vi kan lære av faktiske brudd på personopplysningssikkerheten, og hvordan personvernforordningen setter rammer for trygg bruk.",
      description_en: "Organizations that use open source software in production face the same requirements for personal data security as any other. This presentation highlights what we can learn from actual breaches of personal data security, and how the General Data Protection Regulation sets the framework for safe use.",
      speaker: {
        name: "Fredrik Christensen",
        description: "Seniorrådgiver, Datatilsynet",
        description_en: "Senior Adviser, The Norwegian Data Protection Authority",
    ...
    },
    {
      ...
      description_en: "Thank you for attending the Bergen Open Source Conference!",
      image: "TODO: path to some image in static dir",
