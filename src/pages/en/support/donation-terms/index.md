...
Bergen Open Source, org.no 935344670, offers both recurring monthly donations and one-time donations via Vipps.

For monthly charges, you can choose a fixed donation amount (e.g. 100 NOK), with the first charge in the same month as setup. The amount and frequency (monthly) are confirmed in the Vipps app upon signing.

You can of course also avoid recurring payments and donate a one-time amount whenever you wish!
